...
Marker.prototype.getClassName = function() { 
  return 'marker'; 
}

Marker.prototype._getAccessorList = function() {
  return { x: 0, color: '#000000' };
}

Marker.prototype._getDefaults = function() {
  return {
    handlerWidth: 7,
    handlerHeight: 10,
    displayHandler: true,
...
Marker.prototype.render = function(renderingContext) {
  if (this.el) { 
    return this.el; 
  }
...
Marker.prototype.update = function(renderingContext, group, datum, index) {
...
Marker.prototype.inArea = function(renderingContext, datum, x1, y1, x2, y2) {
