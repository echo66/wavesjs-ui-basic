...
Segment.prototype._getAccessorList = function() {
  return { x: 0, y: 0, width: 0, height: 1, color: '#000000', opacity: 1 };
}

Segment.prototype._getDefaults = function() {
  return {
...
Segment.prototype.render = function(renderingContext) {
  if (this.el) { 
    return this.el; 
  }
...
Segment.prototype.update = function(renderingContext, group, datum, index) {
...
Segment.prototype.inArea = function(renderingContext, datum, x1, y1, x2, y2) {
