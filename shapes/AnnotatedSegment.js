...
AnnotatedSegment.prototype.getClassName = function() { 
  return 'annotated-segment'; 
}

AnnotatedSegment.prototype._getAccessorList = function() {
  let list = super._getAccessorList();
  list.text = 'default';
  return list;
}

AnnotatedSegment.prototype.render = function(renderingContext) {
...
AnnotatedSegment.prototype.update = function(renderingContext, group, datum, index) {
